...
@section('title', 'Agregar Subtítulo')

@section('content_header')
    <div style="display: flex; justify-content: center">
        <h1>
            Agregar Subtítulo a <span class="highlight">{{ $pagina->titulo_paginas }}</span>
        </h1>
    </div>
@stop
        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="form-container">
                    <h2 class="text-center mb-4">Nuevo Subtítulo</h2>

                    <form action="{{ route('admin.subtitulos.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id_pagina" value="{{ $pagina->id }}">

                        <div class="form-group">
                            <label>Título del Subtítulo</label>
                            <input type="text" name="titulo_subtitulo" autocomplete="off" class="form-control" required>
                        </div>

                        <div class="form-group">
                            <label>Resumen</label>
                            <textarea name="resumen" style="height: 280px" class="form-control"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Imagen del Subtítulo</label>
                        ...
                        <div class="floating-btn-container">
                            ...
                            <!-- 🔙 Botón para Regresar -->
                            <a href="{{ route('admin.paginas.show', $pagina) }}" class="floating-btn back-btn"
                                title="Regresar">
